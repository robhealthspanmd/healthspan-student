...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("infrastructure.sqlserver.Data.Entities.ContentTag", b =>
                {
            ...
            modelBuilder.Entity("infrastructure.sqlserver.Data.Entities.ContentTagAssignment", b =>
                {
                    b.Property<int>("ContentTagAssignmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ContentTagAssignmentId"), 1L, 1);
                    ...
                    b.HasKey("ContentTagAssignmentId");
            ...
            modelBuilder.Entity("infrastructure.sqlserver.Data.Entities.ContentTagAssignment", b =>
                {
                    b.HasOne("infrastructure.sqlserver.Data.Entities.ContentCard", null)
                        .WithMany("ContentTagAssignments")
                        .HasForeignKey("ContentCardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("infrastructure.sqlserver.Data.Entities.ContentTag", "ContentTag")
                        .WithMany()
            ...
            modelBuilder.Entity("infrastructure.sqlserver.Data.Entities.ContentCard", b =>
                {
                    ...
                    b.Navigation("ContentTagAssignments");
                });
